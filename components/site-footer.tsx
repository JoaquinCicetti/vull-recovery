import { waLink, SITE_NAME, WHATSAPP_NUMBER } from "@/lib/site";
import { Logo } from "@/components/logo";

// Global footer (shown on every route). Includes a quiet WhatsApp link.
export function SiteFooter() {
  return (
    <footer className="relative z-0 border-t border-border bg-black">
